...
evaluation = dict(interval=500, pipeline=eval_pipeline)
...
# loss 0.34 -> 0.09 까지는 떨어져야함
#resume_from = 'work_dirs/dv-fpn_center_secfpn_adamw_2x8_80e_nus-3d-3class/epoch_200.pth'
